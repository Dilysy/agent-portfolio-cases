...
本仓库用于建设 GitHub 版 Agent 落地案例集，服务于求职、面试展示和轻量级接单沟通。案例围绕企业知识工作流场景进行自主工程化实现、能力封装、流程编排、本地化运行验证和展示材料整理，形成可展示、可复盘、可扩展的 Agent 应用案例。
...
1. 所有案例均表述为“自主工程化实现、场景化构建、能力封装、流程编排和本地化运行验证”，不得写成真实客户交付。
2. 不夸大项目能力，不展示未验证能力。
3. 如果某项能力只是规划，必须写成“后续可扩展”。
4. 不保留 私密凭证、账号、邮箱、微信、浏览器隐私页等敏感信息。
...
用于运行验证和维护。记录工程入口、环境准备、依赖安装、环境变量、启动命令、运行步骤、已知问题、修复记录和当前验证状态。
...
用于记录一次完整演示。包含示例输入、执行过程、工具调用记录、示例输出、人工复核结论、边界说明和优化方向。
...
3. 不夸大项目能力
4. 不使用营销化表达
5. 保持“工程化实现、场景化构建、能力封装、流程编排和本地化验证”的真实口径
6. 每个技术点都要能讲清楚
```
